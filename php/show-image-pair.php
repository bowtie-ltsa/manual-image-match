                                ...
                                <div class="col-sm-12">
                                    <div class="navbar-left">
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <label class="btn btn-primary btn-decision <?=$sameClass?>" <?=$sameChecked?> onclick="setDirty();">
                                              <input type="radio" name="decision" value="1" id="decisionSame" autocomplete="off"> Same
                                            </label>
                                            <label class="btn btn-primary btn-decision <?=$diffClass?>" <?=$diffChecked?> onclick="setDirty();">
